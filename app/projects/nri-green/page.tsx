...
import { nri } from "@/config/projects";
    ...
    <div className="relative bg-[#E6E6E6] w-full h-full text-black">
      ...
      <div className=" sm:px-24 px-2 sm:-mt-[2%] -mt-0">
        ...
        <div className="flex sm:flex-row flex-col sm:gap-0 gap-5 mt-5 px-5 py-2 ">
          <div className="flex flex-col gap-2 items-start w-3/4">
            ...
            <h2 className="text-3xl font-Arimo text-[#BF7E32]">{nri.title}</h2>
            <p className="text-sm font-Arimo w-3/4">{nri.location}</p>
          </div>
          <div className="flex flex-col items-center gap-2 justify-center sm:border-l-2 border-l-0 border-[#BF7E32] px-10 py-5">
            <div className="grid grid-cols-2 font-Arimo gap-5">
              <div className="flex flex-col  items-start">
                <h2>Project Type</h2>
                <p className="text-[#BF7E32] font-semibold">{nri.type}</p>
              </div>
              <div className="flex flex-col  items-start">
                <h2>Bedrooms</h2>
                <p className="text-[#BF7E32] font-semibold">{nri.rooms}</p>
              </div>
              <div className="flex flex-col  items-start">
                <h2>Development Size</h2>
                <p className="text-[#BF7E32] font-semibold">{nri.area} Acres</p>
              </div>
              <div className="flex flex-col  items-start">
                <h2>Total Units</h2>
        ...
        >
          ...
          <ul className="font-Arimo gap-2 flex flex-col px-5">
            {nri.amenities.map((amenity, index) => (
        ...
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3802.5967849353206!2d77.9297294751703!3d17.621871883305896!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTfCsDM3JzE4LjciTiA3N8KwNTUnNTYuMyJF!5e0!3m2!1sen!2sin!4v1738857378108!5m2!1sen!2sin"
          width="600"
          height="450"
          loading="lazy"
          className="w-full"
      ...
      <div className="w-full flex items-center justify-center mb-10">
        ...
        >
          ...
          <CarouselPrevious className="bg-[#BF7E32] text-white sm:block hidden" />
          <CarouselNext className="bg-[#BF7E32] text-white sm:block hidden" />
        </Carousel>
      </div>
      {/* <HorizontalScrollCarousel cards={lavender.gallery} /> */}
      <Footer />
    </div>
  );
}
